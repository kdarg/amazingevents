...
function displayFutureCards(){
    let filtroEventosPasados = aEvents.filter(eachCard=>eachCard.date < dataCompleta.fechaActual)

    impresionAlHtml.innerHTML=""

    filtroEventosPasados.map(events=>{
    ...
    `  <div class="">
            ...
            <div class="col-8">
                ...
                <a class="sacarlink" href="./detalles.html?id=${events.id}">
                    ...
                    Invitados: ${events.assistance || events.estimate } 
                    </p>
                </div>
                <div
